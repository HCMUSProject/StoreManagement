...
(
	ID_KHACHHANG INT IDENTITY(0,1) NOT NULL,
...
(
	...
	CONSTRAINT LICHSUBANHANG_FK_KHACHHANG FOREIGN KEY(ID_KHACHHANG) REFERENCES KHACHHANG(ID_KHACHHANG)
)
...
@TenKH NVARCHAR(50), @CMND NVARCHAR(20), @SDT NVARCHAR(20), @DiaChi NVARCHAR(100)
AS
	BEGIN
		INSERT INTO KHACHHANG VALUES(@TenKH, @CMND, @SDT, @DiaChi, 0)
	END


CREATE PROCEDURE ThemLichSuBanHang
@MaKH INT, @NgayMua DATE
AS
	BEGIN
		INSERT INTO LICHSUBANHANG VALUES(@MaKH, @NgayMua, 0)
	END
